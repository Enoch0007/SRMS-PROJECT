...
class reportClass:
    def __init__(self,root):
        ...
        #--title--
        title=Label(self.root,text="View Student Results",font=("goudy old style",30,"bold"),bg="orange",fg="blue").place(x=0,y=0,relwidth=1,height=50)
        ...
        btn_search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),bg="dark blue",fg="white",cursor="hand2",command=self.search).place(x=680,y=100,width=100,height=35)
        btn_clear=Button(self.root,text="Clear",font=("goudy old style",15,"bold"),bg="dark blue",fg="white",cursor="hand2",command=self.clear).place(x=795,y=100,width=100,height=35)
        ...
        #--button delete--
        btn_delete=Button(self.root,text="Delete",font=("goudy old style",15,"bold"),bg="dark blue",fg="white",cursor="hand2",command=self.delete).place(x=500,y=350,width=150,height=35)
    ...
    def delete(self):
        ...
        try:
            if self.var_id=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Ivalid Student Result",parent=self.root)
                else:
