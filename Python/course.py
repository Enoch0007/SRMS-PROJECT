...
class CourseClass:
    def __init__(self,root):
        ...
        #--title--
        title=Label(self.root,text="Manage Course Details",font=("goudy old style",30,"bold"),bg="orange",fg="blue").place(x=0,y=0,relwidth=1,height=50)
        ...
        txt_duration=Entry(self.root,textvariable=self.var_duration,font=("goudy old style",15,"bold"),bg="light yellow").place(x=150,y=100,width=200)
